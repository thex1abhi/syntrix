            ...
            <>
                {
                    ...
                    transition-colors duration-150 bg-transparent border-none cursor-pointer shrink-0 ">
                                {onClose ? <X size={15} /> : <PanelRightClose size={16} className="" />}
                            </button> 
                        ...
                        {tab === "code" && <div className="flex  h-auto  border-b  border-white/[0.0] overflow-x-auto [scrollbar-width:none]   [&::-webkit-scrollbar]:hidden shrink-0   ">
                        ...
                        <div className="flex-1 overflow-hidden">
                            {tab == "preview" && canPreview ?
                                ...
                                >
                                    <iframe title="preview" sandbox="allow-scripts" srcDoc={previewDoc}
                                ...
                                <motion.div
                                    ...
                                    <Editor theme="vs-dark"
                                        ...
                                        options={{
                                            ...
                                            scrollBeyondLastLine: false, padding: { top: 16 }, lineNumbers: "on",
    ...
    return (
        <>
            ...
            <button
                ...
                className="lg:hidden fixed bottom-24 right-4 z-40 flex items-center justify-center gap-2   px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500  text-white text-[12px]  font-medium shadow-lg  shadow-indigo-500/20 border-none cursor-pointer  transition-colors  duration-150  ">
                <Code2 size={13} />
                View Code
            </button>
                ...
                {mobileOpen &&
                    <>
                        ...
                        <motion.div
                            ...
                            animate={{ x: 0 }}
                            transition={{ duration: 0.25, ease: "easeInOut" }}
                            className="lg:hidden  fixed inset-y-0  right-0 z-50 w-[88vw] 
                             max-w-[420px]  border-1  border-white/[0.06]  overflow-hidden  "
                        >
