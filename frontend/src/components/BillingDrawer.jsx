        ...
        <AnimatePresence >
            {open && <> <motion.div
                ...
                <motion.div
                    ...
                    className="fixed right-0  top-0 z-50 h-screen w-[380px]  bg-[#0f1117] border-1 
                    ...
                    <div className="px-5 flex-1 overflow-auto space-y-4  ">
                        <div className="rounded-xl border border-white/10 p-4  ">
                            ...
                            <button
                                ...
                                className="mt-4 cursor-pointer  w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white   "> Upgrade </button>
                        </div>
                        <div className="rounded-xl border border-white/10 p-4  ">
